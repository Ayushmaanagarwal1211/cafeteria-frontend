...
const Skeleton = () => {
  return (
    ...
    <div className="animate-pulse p-4 bg-white dark:bg-gray-800 rounded-2xl shadow-md w-full max-w-sm">
      {/* Image Skeleton */}
...
export function CounterDetailsSkeleton(){
  ...
  <div className="animate-pulse">
    <div className="h-8 bg-gray-300 dark:bg-gray-700 rounded-lg w-2/3 mx-auto mb-4"></div>
    <div className="h-4 bg-gray-300 dark:bg-gray-600 rounded-lg w-1/3 mx-auto"></div>
  </div>
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    {Array.from({ length: 2 }).map((_, i) => (
      <div
        key={i}
        className="animate-pulse bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 border border-gray-200 dark:border-gray-600"
      >
