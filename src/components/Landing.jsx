...
export default function Landing() {
  ...
  return (
    ...
    {/* Right side - Content */}
    <div className="w-full dark:bg-gray-800 lg:w-1/2 p-8 lg:p-12 space-y-8 flex flex-col justify-center animate-fade-in delay-150 bg-white/90 backdrop-blur-md rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300">
      <div className="space-y-4 animate-fade-in delay-300">
        <h1 className="text-4xl lg:text-5xl text-white font-bold  mb-2 tracking-tight animate-slide-up">
          Welcome Back
        </h1>
        <p className=" text-white  text-lg animate-slide-up delay-200">
